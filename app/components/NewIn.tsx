  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        console.error('Failed to load new-in products', e);
      } finally {
  ...
  if (loading) return (
    <section className="py-8">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-900 mb-12">New In</h2>
    ...
    <section className="py-8">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center mb-6">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900">New In</h2>
        </div>
